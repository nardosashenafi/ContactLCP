  ...
  ;%***********************
    ...
    ;%
	  ...
	  section.data(34).dtTransOffset = 391;
	
	  ;% cartpole_MOE_2019a_P.rm
	  section.data(35).logicalSrcIdx = 34;
	  section.data(35).dtTransOffset = 392;
	  ...
	  ;% cartpole_MOE_2019a_P.Merge_InitialOutput_g
  ...
  ;%**************************
    ...
    ;%
	  ...
	  ;% cartpole_MOE_2019a_B.Sum1_e
	  section.data(18).logicalSrcIdx = 19;
	  section.data(18).dtTransOffset = 25;
	
	  ;% cartpole_MOE_2019a_B.Sum_c
  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% cartpole_MOE_2019a_DW.Selectcontroller_ActiveSubsyste
  ...
  targMap.checksum0 = 544088241;
  targMap.checksum1 = 3728286217;
  targMap.checksum2 = 2885890186;
  targMap.checksum3 = 3830767550;
