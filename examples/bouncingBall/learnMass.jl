...
function oneStep(lcp::ContactLCP.Lcp, x1, θm::AbstractArray{T}; Δt = 0.001f0) where {T<:Real}
...
function trajectory(lcp::ContactLCP.Lcp, x0, θm::AbstractArray{T}; Δt = 0.001f0, totalTimeStep = 1500) where {T<:Real}
